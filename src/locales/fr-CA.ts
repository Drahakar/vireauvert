...
export default {
    ...
    tutorial_step_highlight: "<p>Certaines années contiennent des <b>faits saillants</b>. Ceux-ci représentent une <b>synthèse</b> d'événements historiques importants pour cette année. Cliquez sur les icônes brillantes pour en savoir plus.</p><p>Un <b>point rouge</b> est visible dans la ligne du temps pour les années contenant un fait saillant.</p>",
